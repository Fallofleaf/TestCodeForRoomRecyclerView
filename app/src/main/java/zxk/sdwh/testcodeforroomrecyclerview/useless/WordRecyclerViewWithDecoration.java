...
import zxk.sdwh.testcodeforroomrecyclerview.R;


public class WordRecyclerViewWithDecoration extends RecyclerView.ItemDecoration {
    ...
    public WordRecyclerViewWithDecoration(Context context, DecorationCallback decorationCallback) {
